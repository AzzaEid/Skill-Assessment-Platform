    ...
    public class InterviewBookMapper
    {
        public void Configure(EntityTypeBuilder<InterviewBook> builder)
        {
            ...
            builder.HasOne(ib => ib.Feedback)
                .WithOne(f => f.InterviewBook)
                .HasForeignKey<InterviewBook>(ib => ib.FeedbackId)
                .OnDelete(DeleteBehavior.Restrict);
            ...
            builder.HasOne(ib => ib.StageProgress)
                .WithMany(sp => sp.InterviewsBooks)
                .HasForeignKey(ib => ib.StageProgressId)
                .OnDelete(DeleteBehavior.Restrict);
